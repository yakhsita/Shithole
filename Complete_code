...
# map
fmap_img = PhotoImage(file = "C:/Users/shrirang/Desktop/map.png") # Storing the photo in a variable
...
def frame2(): # Loading
    ...
    global g
    g = tk.Label(frame, text="Game loading . . .", bg='black', fg='white', font=('Times New Roman', 30, 'bold'),
                 border=3)
    g.place(relx=0.3, rely=0.45)

    # f2_pic_label.img = f5_img
    # f2_pic_label.place(x=-10, y=90)

    root.after(2000, frame3)


def frame1(): # First page
    global b2
    b1.destroy()
    photo_label.destroy()
    exit_button.destroy()
