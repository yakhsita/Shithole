...
photo = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/background.png"))
photo_label = tk.Label(frame, image=photo, bg='black')  # making the image into a label
photo_label.place(x=0, y=-2)

# frame1 stuff
f1_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/welcome.png"))
...
f14_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/crowbar.png"))
...
# frame26ha stuff <-- Run
f26ha_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/death.png"))
f26ha_pic_label = Label(frame, image=f26ha_img)
y25 = tk.Label(frame,
               text="You turn around and run,\nBut you can't get through. It's an impenetrable swarm of flies.\nYou try but you get eaten to death by those flies.\nYou wake up in the white room.\nMaybe next time you should find something to defend yourself with...",
               font=("Times New Roman", 16), justify="center", bg="black", fg="white")

# frame27 stuff <-- Exit
f27_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/locker.png"))
f27_pic_label = Label(frame, image=f27_img)
y26 = tk.Label(frame,
               text="You are at the Exit. Or you hope it is.\nThere's a safe with a FOUR letter code. Do you wish to try?\nRemember, you have a limited amount of attempts.\nHead Back if you think you aren't ready.",
               font=("Times New Roman", 18), justify="center", bg="black", fg="white")

# frame28 stuff <-- Try
f28_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/locker.png"))
f28_pic_label = Label(frame, image=f28_img)
y27 = tk.Label(frame, text="REMEMBER, you have 1 attempt only.\n\nGuess the 4-letter word (all lowercase)",
               font=("Times New Roman", 18), justify="center", bg="black", fg="white")

# frame29 stuff <-- Try(Entry correct)(In Exit)
f29_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/openlocker.png"))
...
# frame31 stuff
# f31_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/Bugspray.png"))
...
# frame33 stuff <-- Safe
f33_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/locket.png"))
...
f34_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/terrace.png"))
...
# frame38 stuff <-- ending 1/2
f38_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/end2.png"))
...
# crowbar-picked!
crowbarpick = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/crowbarpick.png"))
crowbarpick_label = Label(frame, image=crowbarpick)

# bugspray picked!
bugspraypick = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/Bugspray.png"))
bugspraypick_label = Label(frame, image=bugspraypick)

# map
fmap_img = ImageTk.PhotoImage(Image.open("C:/Users/shrirang/Desktop/map.png"))  # Storing the photo in a variable
...
def frame22():  # OR no death w/out crowbar
    y17.place_forget()
    b3.place_forget()
    f3_pic_label.pack_forget()
...
def frame21():  # OR death w/ crowbar
    y16.place_forget()
    b3.place_forget()
...
def frame19():  # left -> operation area
    ...
    if "crowbar" in inventory:
        ...
        b19b = tk.Button(frame, text="Escape By Fighting", bg="black", fg="white", font=("Times New Roman", 20),
                         border=2,
                         command=frame21)
...
def frame18():  # waiting area
    ...
    b18b = tk.Button(frame, text="Right", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame23)
    ...
    b18d = tk.Button(frame, text="Exit", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame27)
...
def frame15():  # terrace
    ...
    b15a = tk.Button(frame, text="Back", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame13)
    b15a.place(x=356, y=340)

    b15b = tk.Button(frame, text="Jump", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame16)
...
def frame14():  # crowbar show up
    ...
    b14a = tk.Button(frame, text="Pick Up", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=callback1)
    b14a.place(x=580, y=300)

    b14b = tk.Button(frame, text="Leave It", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame15)
...
def frame13():  # staircase
    ...
    if "crowbar" not in inventory:
        b13a = tk.Button(frame, text="Up", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                         command=frame14)
        b13a.place(x=430, y=220)
    else:
        b13c = tk.Button(frame, text="Up", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                         command=frame15)
        b13c.place(x=430, y=220)

    b13b = tk.Button(frame, text="Down", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame18)
...
def frame9c():  # bathroom -> black
    ...
    b9ca = tk.Button(frame, text="Corridor", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame6)
...
def frame9a():  # bathrooom -> red
    ...
    b9aa = tk.Button(frame, text="Continue...", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                     command=frame4)
...
def frame7():  # bathroom
    ...
    b7a = tk.Button(frame, text="Inspect Knocking", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                    command=frame8)
...
def frame6():  # door-> corridor
    ...
    b6a.place(x=200, y=550)

    b6b = tk.Button(frame, text="Right", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                    command=frame10)
...
def frame4():  # whiteroom
    ...
    y1.place(x=170, y=370)

    global b4a
    global b4b

    b4a = tk.Button(frame, text="Inspect", bg="black", fg="white", font=("Times New Roman", 20), border=2,
                    command=frame5)
    b4a.place(x=200, y=500)

    b4b = tk.Button(frame, text="Door", bg="black", fg="white", font=("Times New Roman", 20), border=2, command=frame6)
    b4b.place(x=450, y=500)
...
b1.place(relx=0.439,
         rely=0.60)  # It's out of the def function, hence is the first most button that appears, the click button

exit_button = tk.Button(frame, text='QUIT', bg='black', fg='white', font=('Courier', 18, 'bold'), border=3,
                        command=root.destroy)
